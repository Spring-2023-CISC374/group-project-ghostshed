...
const TutorialStepText = [
  'Let\'s start with moving to all four zones. Use the arrow keys to travel to each. Just press any of them once and you\'ll travel there',
  ...
  'Excellent! You have learned the ropes to ghost fighting. Click continue to try your hand in a real haunted shed...'
]
